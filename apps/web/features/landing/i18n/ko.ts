      ...
      entries: [
        {
          version: "0.3.22",
          date: "2026-06-15",
          title: "목록 경험, 실행 설정, 더 안전한 Issue 편집",
          changes: [],
          features: [
            "에이전트, 오토파일럿, 프로젝트, 런타임, 스킬, 스쿼드가 더 빠른 목록 경험을 공유하며 행, 작업, 필터, 선택 상태가 더 명확해졌습니다.",
            "CLI에서 워크스페이스 저장소를 관리할 수 있어 로컬 에이전트에 필요한 프로젝트 저장소 정보를 더 쉽게 준비할 수 있습니다.",
            "Cursor와 OpenClaw 설정에 관리형 Cursor MCP 설정과 기존 OpenClaw 게이트웨이 연결 등 새로운 실행 옵션이 추가되었습니다.",
            "댓글을 편집할 때 저장하기 전에 어떤 에이전트나 스쿼드가 실행될지 확인하고 제어할 수 있습니다.",
          ],
          improvements: [
            "데스크톱 복구 안내에 페이지 맥락이 더 많이 포함되어 멈춘 창이 어디에서 실패했는지 설명하기 쉬워졌습니다.",
          ...
          fixes: [
            "Issue 첨부 파일, 본문 이미지, 파일 카드가 웹, 데스크톱, 모바일, 토큰 기반 클라이언트에서 더 안정적으로 열립니다.",
            "편집기와 읽기 전용 Issue 내용에서 금액의 달러 기호와 이메일 링크가 더 정확하게 처리됩니다.",
            "데스크톱 Cmd+W는 먼저 활성 탭을 닫고, 닫을 탭이 없을 때 창을 닫습니다.",
            "셀프 호스트 Docker Compose 업로드와 기본값이 덜 실패하고, 빠진 설정값을 더 일찍 확인합니다.",
            "에이전트 작업 실행 토큰이 유효하지 않으면 더 안전하게 실행을 중단합니다.",
          ],
        },
        {
          version: "0.3.21",
