      ...
      entries: [
        {
          version: "0.3.29",
          date: "2026-06-24",
          title: "더 똑똑한 Issue 읽기와 더 안정적인 예약 오토파일럿",
          changes: [],
          features: [
            "에이전트가 긴 Issue 토론을 읽을 때 해결된 스레드는 핵심 결론 중심으로 접혀, 이미 정리된 대화보다 현재 작업에 더 집중할 수 있습니다.",
          ],
          improvements: [
            "예약 오토파일럿이 놓친 실행, 서비스 재시작, 여러 작업자가 동시에 움직이는 상황에서도 더 안정적으로 동작해 같은 예약 시점은 한 번만 처리됩니다.",
          ],
          fixes: [
            "채팅 작업을 취소해 입력창으로 돌아온 텍스트를 지우면, 다른 곳으로 이동했다가 돌아와도 다시 나타나지 않습니다.",
            "@멘션 검색은 실시간 검색 결과로 목록 순서가 바뀌어도 강조된 결과를 정확히 선택합니다.",
          ],
        },
        {
          version: "0.3.28",
