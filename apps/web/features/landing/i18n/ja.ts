      ...
      entries: [
        {
          version: "0.3.22",
          date: "2026-06-15",
          title: "リスト体験、実行設定、より安全な Issue 編集",
          changes: [],
          features: [
            "エージェント、オートパイロット、プロジェクト、ランタイム、スキル、スクワッドで、行表示、操作、絞り込み、選択状態がそろった高速なリスト体験を使えるようになりました。",
            "CLI でワークスペースのリポジトリを管理できるようになり、ローカルエージェントに必要なプロジェクトのリポジトリ情報を準備しやすくなりました。",
            "Cursor と OpenClaw の設定に、管理された Cursor MCP 設定や既存の OpenClaw ゲートウェイ接続など、新しい実行オプションが加わりました。",
            "コメント編集時に、保存前にどのエージェントやスクワッドが動き始めるかを確認し、制御できるようになりました。",
          ],
          improvements: [
            "デスクトップの復旧案内にはページの文脈がより多く含まれるため、固まったウィンドウの場所を説明しやすくなりました。",
          ...
          fixes: [
            "Issue の添付ファイル、本文内画像、ファイルカードは、Web、デスクトップ、モバイル、トークン経由の表示でより安定して開けるようになりました。",
            "エディターと読み取り専用の Issue 内容で、金額のドル記号とメールリンクがより正しく扱われます。",
            "デスクトップの Cmd+W は、まず現在のタブを閉じ、閉じられるタブがない場合にウィンドウを閉じます。",
            "セルフホストの Docker Compose アップロードと既定値は失敗しにくくなり、足りない設定値も早めに見つかります。",
            "エージェントタスクの実行トークンが無効な場合は、より安全に実行を止めるようになりました。",
          ],
        },
        {
          version: "0.3.21",
