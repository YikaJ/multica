      ...
      entries: [
        {
          version: "0.3.29",
          date: "2026-06-24",
          title: "Issue 読み取りの改善と予約オートパイロットの安定化",
          changes: [],
          features: [
            "エージェントが長い Issue の議論を読むとき、解決済みスレッドは重要な結論を中心に折りたたまれ、すでに終わったやり取りより現在の作業に集中できます。",
          ],
          improvements: [
            "予約オートパイロットは、実行漏れ、サービス再起動、複数ワーカーの同時動作があってもより安定し、同じ予約時刻は一度だけ処理されます。",
          ],
          fixes: [
            "チャット作業をキャンセルして入力欄に戻った文章を削除した場合、別の画面へ移動して戻っても再表示されません。",
            "@メンション検索は、リアルタイム検索で一覧の順番が変わっても、ハイライトされた結果を正しく選びます。",
          ],
        },
        {
          version: "0.3.28",
